...
#' Reconstruct a decomposition from a signature
#'
#' Generates reconstructed substitution profile (decompositions) generated by proportionally combining each estimated contribution.
#'
#' @param signature a data.frame in sigverse signature format
#' @param n total number of variants to use for reconstruction
#'
#' @return data.frame conforming to sigverse decomposition format
#' @export
#'
#' @examples
#' library(sigstash)
...
#' signature <- sig_combine_collapse_to_single_signature(combined_signatures)
#'
#' # Reconstruct a perfect decomposition describing what the mutational profile of a sample
